...
public class WildcardCharacters_M {

    public static boolean WildcardCharacters_M(String str) {
...
//        System.out.println(WildcardCharacters_M(s));

        String s1 = "**+*{2} mmmrrrkbb";
        System.out.println(WildcardCharacters_M(s1));
    }
